...
export default function Product(){
  ...
  <div className="absolute flex flex-col items-center justify-center w-[106px] h-[133px] left-1/2 top-[61px] transform -translate-x-1/2">
    <Image
      ...
      alt="Image 2"
    />
    <div className="text-black text-6xl font-medium font-['Poppins']">Blog</div>
  </div>

  {/* Breadcrumb Section */}
  <div className="absolute flex items-center gap-2 left-1/2 top-[195px] transform -translate-x-1/2 mt-2">
    <div className="text-black text-base font-medium font-['Poppins']">Home</div>
     <IoIosArrowForward className="text-black font-light"/>
    <div className="text-black text-base font-light font-['Poppins']">Blog</div>
  </div>
</div>

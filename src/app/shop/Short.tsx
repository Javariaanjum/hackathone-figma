 import {FaTrophy ,FaTachometerAlt  , FaTruck, FaHeadset } from "react-icons/fa";

const Short = () => {
  return (
    <div className="w-full bg-[#faf3ea] py-10 flex flex-col items-center mt-16">
      <div className="flex justify-between items-center w-[90%] max-w-[1334px]">
        ...
        <div className="flex items-center gap-2.5">
          <div className="w-[60px] h-[60px] flex justify-center items-center bg-gray-200 rounded-full">
             <FaTachometerAlt  className="text-[#242424] text-3xl"/>
          </div>
          <div className="flex flex-col">
